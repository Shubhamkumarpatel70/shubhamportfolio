    ...
    <div className="min-h-screen flex items-center justify-center py-8 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-card-bg/80 backdrop-blur-md border border-primary/20 p-8 rounded-2xl shadow-2xl">
          <h1 className="text-3xl md:text-4xl font-bold mb-2 text-center text-text-primary">Login</h1>
          <p className="text-center text-text-primary/70 mb-6">Welcome back! Please login to your account.</p>
          ...
          <p className="text-center mt-6 text-text-primary/70">
            ...
            <Link to="/register" className="text-primary font-medium hover:text-blue-400 hover:underline transition-colors">
              Register here
            </Link>
          </p>
        </div>
